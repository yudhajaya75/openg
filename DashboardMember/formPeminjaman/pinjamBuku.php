...
$nisnSiswa = $_SESSION["member"]["no_ktp"];
$dataSiswa = queryReadData("SELECT * FROM member WHERE no_ktp = $nisnSiswa");
  ...
  <div class="p-4 mt-5">
      ...
      <div class="card-body d-flex flex-wrap gap-4 justify-content-center">
        ...
        <form action="" method="post">
          ...
          <div class="input-group mb-3">
            ...
            <input type="number" class="form-control" placeholder="no_ktp" aria-label="no_ktp" aria-describedby="basic-addon1" value="<?= $item["no_ktp"]; ?>" readonly>
            </div>
          <div class="input-group mb-3">
    ...
    <div class="card mt-4">
      ...
      <div class="card-body">
        ...
        <div class="input-group mb-3">
            <span class="input-group-text" id="basic-addon1">No Ktp</span>
            <input type="number" name="no_ktp" class="form-control" placeholder="no_ktp" aria-label="no_ktp" aria-describedby="basic-addon1" value="<?php echo htmlentities($_SESSION["member"]["no_ktp"]); ?>" readonly>
        </div>
    <!--Ambil data id admin-->
    ...
    <div class="input-group mb-3 mt-3">
            ...
            <input type="date" name="tgl_pengembalian" id="tgl_pengembalian" class="form-control" placeholder="tgl_pengembalian" aria-label="tgl_pengembalian" aria-describedby="basic-addon1">
      </div>

      <div class="input-group mb-3 mt-3">
    <span class="input-group-text" id="basic-addon1">Harga</span>
    <input type="text" name="harga" id="harga" class="form-control" aria-label="harga" aria-describedby="basic-addon1" readonly>
</div>
