...
if(isset($_POST["signIn"]) ) {
  ...
  $result = mysqli_query($connect, "SELECT * FROM member WHERE nama = '$nama' AND no_ktp = $no_ktp");
...
<!DOCTYPE html>
  ...
  <div class="input-group mt-0">
    ...
    <input type="number" class="form-control" name="no_ktp" id="validationCustom01" required>
    <div class="invalid-feedback">
        No Ktp wajib diisi!
    </div>
  </div>
